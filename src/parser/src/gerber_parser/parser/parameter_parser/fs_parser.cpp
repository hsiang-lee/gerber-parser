...
FsParser::FsParser(GerberParserImpl& gerber, ParameterParser& param_parser)
...
bool FsParser::Run() {
  ...
  while (gerber_parser_.gerber_file_->pointer_ <
    ...
    switch (gerber_parser_.gerber_file_->PeekChar()) {
      ...
      case 'X':
        gerber_parser_.gerber_file_->pointer_++;
        gerber_parser_.format_.XInteger =
            gerber_parser_.gerber_file_->GetChar() - '0';
        gerber_parser_.format_.XDecimal =
            gerber_parser_.gerber_file_->PeekChar() - '0';
        break;

      case 'Y':
        gerber_parser_.gerber_file_->pointer_++;
        gerber_parser_.format_.YInteger =
            gerber_parser_.gerber_file_->GetChar() - '0';
        gerber_parser_.format_.YDecimal =
            gerber_parser_.gerber_file_->PeekChar() - '0';
        break;
      ...
      default:
        Log::log_ << "Line " << gerber_parser_.gerber_file_->line_number_
                  << " - Error: Unrecognised FS modifier: "
