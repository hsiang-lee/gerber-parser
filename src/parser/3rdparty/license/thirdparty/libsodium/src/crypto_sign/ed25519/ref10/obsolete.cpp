...
/* LCOV_EXCL_START */
int crypto_sign_edwards25519sha512batch_keypair(unsigned char *pk, unsigned char *sk) {
  ge25519_p3 A;
...
int crypto_sign_edwards25519sha512batch(unsigned char *sm, unsigned long long *smlen_p, const unsigned char *m, unsigned long long mlen,
...
int crypto_sign_edwards25519sha512batch_open(unsigned char *m, unsigned long long *mlen_p, const unsigned char *sm, unsigned long long smlen,
  ...
  *mlen_p = 0;
  ...
  if (ge25519_has_small_order(pk) != 0 || ge25519_frombytes_negate_vartime(&A, pk) != 0 || ge25519_has_small_order(sm) != 0 ||
