                     ...
                     const size_t encodedlen)
{
    return argon2_hash(t_cost, m_cost, parallelism, pwd, pwdlen, salt, saltlen,
                       nullptr, hashlen, encoded, encodedlen, Argon2_i);
}
...
{
    return argon2_hash(t_cost, m_cost, parallelism, pwd, pwdlen, salt, saltlen,
                       hash, hashlen, nullptr, 0, Argon2_i);
}
...
{
    return argon2_hash(t_cost, m_cost, parallelism, pwd, pwdlen, salt, saltlen,
                       nullptr, hashlen, encoded, encodedlen, Argon2_id);
}
...
{
    return argon2_hash(t_cost, m_cost, parallelism, pwd, pwdlen, salt, saltlen,
                       hash, hashlen, nullptr, 0, Argon2_id);
}
              ...
              argon2_type type)
{
    ...
    ret = argon2_hash(ctx.t_cost, ctx.m_cost, ctx.threads, pwd, pwdlen,
                      ctx.salt, ctx.saltlen, out, ctx.outlen, nullptr, 0, type);
