                                ...
                                const char * const ignore, size_t padding_len)
{
    ...
    while (padding_len > 0) {
        ...
        if (c == '=') {
            padding_len--;
        } else if (ignore == nullptr || strchr(ignore, c) == nullptr) {
            errno = EINVAL;
            return -1;
        }
        (*b64_pos_p)++;
                  ...
                  const char ** const b64_end, const int variant)
{
    ...
    while (b64_pos < b64_len) {
        ...
        if (d == 0xFF) {
            if (ignore != nullptr && strchr(ignore, c) != nullptr) {
                b64_pos++;
                continue;
            }
            break;
    ...
    if (ret != 0) {
        bin_pos = (size_t) 0U;
    } else if (ignore != nullptr) {
        while (b64_pos < b64_len && strchr(ignore, b64[b64_pos]) != nullptr) {
            b64_pos++;
        }
    }
    if (b64_end != nullptr) {
