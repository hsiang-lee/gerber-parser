...
static inline void aegis256_update(aes_block_t *const state, const aes_block_t d) {
  aes_block_t tmp;
...
struct aegis256_implementation aegis256_armcrypto_implementation = {SODIUM_C99(.encrypt_detached =) encrypt_detached,
