...
static inline void aegis128l_update(aes_block_t *const state, const aes_block_t d1, const aes_block_t d2) {
  aes_block_t tmp;
...
struct aegis128l_implementation aegis128l_armcrypto_implementation = {SODIUM_C99(.encrypt_detached =) encrypt_detached,
