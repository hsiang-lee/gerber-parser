...
# ifdef __EMSCRIPTEN__
#  define RANDOMBYTES_DEFAULT_IMPLEMENTATION nullptr
# else
...
#ifndef __EMSCRIPTEN__
    randombytes_init_if_needed();
    if (implementation->stir != nullptr) {
        implementation->stir();
    }
#else
    EM_ASM({
...
#ifndef __EMSCRIPTEN__
    randombytes_init_if_needed();
    if (implementation->uniform != nullptr) {
...
{
    if (implementation != nullptr && implementation->close != nullptr) {
